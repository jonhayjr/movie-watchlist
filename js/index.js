...
let movieData = JSON.parse(localStorage.getItem("movies")) ? JSON.parse(localStorage.getItem("movies")) : [];
...
movieContainer.addEventListener('click', (e) => {
    if (e.target.id === 'watchlist-add-btn') {
            ...
            const index = watchlistMovies.findIndex(item => movie.Title === item.Title); //Get index of movie in watchlistMovies array
